        ...
        <div class="app-content-header">
            ...
            <div class="container">
                <div class="form-container">
                    ...
                    <form id="donationForm" method="post" action="{{route('adminblog.update', $blog->id)}}"   enctype="multipart/form-data">
                        @csrf
                        <div class="form-section">
                            <div class="input-group">
                                <label for="companyName">Title</label>
                                <input type="text" id="companyName" value="{{$blog->title}}" name="title" required>
                            </div>

                            <div class="input-group">
                                <label for="contactName">Select Imges</label>
                                <input type="file" id="contactName" value="{{$blog->img}}" name="img" required>
                            </div>

                            <div class="input-row">
                                <div class="input-group">
                                    <label for="email">Description</label>
                                    <input type="text" id="email" value="{{$blog->description}}" name="description" required>
                                </div>
                            ...
                            <div class="input-group d-flex justify-content-start" style="margin-top: 20px;">
                                <button type="submit" class="btn btn-outline-warning btn-lg"
                                    style="margin-right: 10px;">Edit Blog</button>
                            </div>
                        </div>
