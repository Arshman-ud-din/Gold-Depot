                    ...
                    <form method="post" action="{{route('admincategory.update', $category->id)}}" enctype="multipart/form-data">
                        ...
                        <div class="form-section">
                            <div class="input-group">
                                ...
                                <input type="text" value="{{$category->name}}" id="companyName" name="name">
                                @error('name')
                            ...
                            <div class="input-group">
                                ...
                                <input type="file" id="contactName" value="{{$category->image}}" name="img" required>
                                @error('image')
                                    <div class="alert alert-danger">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="input-group d-flex justify-content-start" style="margin-top: 20px;">
                                <button type="submit" class="btn btn-outline-warning btn-lg"
                                    style="margin-right: 10px;">Edit Category</button>
                            </div>
