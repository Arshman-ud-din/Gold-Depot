        ...
        <div class="app-content-header">
            ...
            <div class="container">
                <div class="form-container">
                    ...
                    <form method="post" action="{{ route('adminvariants.store') }}">
                        @csrf
                        <div class="form-section">
                            <h2>Add Variants</h2>

                            <div class="input-group">
                                <label for="categories">Attributes</label>
                                <select id="cars" value="{{ old('attribute_id') }}" name="attribute_id">
                            ...
                            <div class="input-group d-flex justify-content-start" style="margin-top: 20px;">
                                <button type="submit" class="btn btn-outline-warning btn-lg"
                                    style="margin-right: 10px;">Add Variants</button>
                            </div>
                        </div>
                    </form>
