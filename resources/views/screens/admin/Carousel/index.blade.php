            ...
            <div class="container">
                <div class="form-container">
                    <div class="form-header">
                        <h1>Add Carousel Images</h1>
                    </div>

                    <form id="donationForm" method="post" action="{{route('admincarousel.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-section">
                            ...
                            <div class="input-group d-flex justify-content-start" style="margin-top: 20px;">
                                <button type="submit" class="btn btn-outline-warning btn-lg"
                                    style="margin-right: 10px;">Add Carousel</button>
                            </div>
                        </div>
                    </form>
