        ...
        <div class="app-content-header">
            ...
            <div class="container">
                <div class="form-container">
                    ...
                    <form method="post" action="{{ route('adminattribute.update', $attribute->id) }}">
                        @csrf
                        <div class="form-section">
                            <h2>Edit Attributes</h2>
                            <div class="input-group">
                                <label for="companyName">Name</label>
                                <input type="text" id="companyName" name="name" value="{{ $attribute->name }}"
                                    required>
                                @error('name')
                            ...
                            <div class="input-group d-flex justify-content-start" style="margin-top: 20px;">
                                <button type="submit" class="btn btn-outline-warning btn-lg"
                                    style="margin-right: 10px;">Edit Attributes</button>
                            </div>
                        </div>
                    </form>
